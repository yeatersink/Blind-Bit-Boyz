...
// Section 1<section class="bg-gray-800 text-center">
    <h1 class="mb-4 text-3xl font-bold uppercase text-gold-500">
      Welcome to the Token Search and Analysis Page
    </h1>
    <nav>
      <h2>Contents</h2>
      <ul>
  ...
  <section class="bg-gray-800 text-center" id="introduction">
  ...
  <div class="flex flex-col md:flex-row max-w-6xl mx-auto px-4 pt-20">
    <div class="md:w-1/2 mt-8 md:mt-0">
      <img
        src="best_bit_pool.png"
        alt="Image is of a bitcoin man, swimming in a pool of cash."
        class="w-full h-auto object-cover sticky top-20"
      />
    </div>
  </div>
